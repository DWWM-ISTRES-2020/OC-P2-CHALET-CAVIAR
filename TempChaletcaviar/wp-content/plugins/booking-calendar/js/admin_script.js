...
jQuery( document ).ready(function() {
	...
	*/
	...
	$("body").on( "click", "#wpdevart_export", function(e){	
		...
		window.location = wpdevart_admin.ajaxUrl + "?action=wpdevart_export&wpdevart_nonce=" + wpdevart_admin.ajaxNonce + "&wpdevart_page=" + jQuery('input[name="wpdevart_page"]').val() + "&reserv_period_start=" + jQuery('input[name="reserv_period_start"]').val()+ "&reserv_period_end=" + jQuery('input[name="reserv_period_end"]').val() + "&wpdevart_serch=" + jQuery('input[name="wpdevart_serch"]').val() + "&all_pages=" + all_pages + "&reserv_status=" + dataFilters;
