...
{
    if(!wpl_carousel_property_ids<?php echo $this->widget_id; ?>) wpl_carousel_property_ids<?php echo $this->widget_id; ?> = wplj("#<?php echo $this->get_field_id('data_property_ids'); ?>").val();
