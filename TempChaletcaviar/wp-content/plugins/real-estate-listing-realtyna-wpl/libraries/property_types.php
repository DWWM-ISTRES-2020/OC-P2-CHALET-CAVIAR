...
class wpl_property_types
{
	...
	{
		$id = wpl_db::q("INSERT INTO `#__wpl_property_types` (`parent`,`enabled`,`editable`,`index`,`listing`,`name`) VALUES ('0', '1', '2', '00.00', '0', '$name')", 'insert');
		wpl_db::q("UPDATE `#__wpl_property_types` SET `index`='$id.00' WHERE `id`='$id'");
