...
elseif($format == 'unit' and !$done_this)
{
	if($value != '-1' and trim($value) != '')
	{
        ...
        $min = (isset($vars['sf_min_'.$table_column]) and $vars['sf_min_'.$table_column] != '-1') ? str_replace(',', '', $vars['sf_min_'.$table_column]) : 0;
		$max = (isset($vars['sf_max_'.$table_column]) and $vars['sf_max_'.$table_column] != '-1') ? str_replace(',', '', $vars['sf_max_'.$table_column]) : 0;
...
elseif($format == 'mmunit' and !$done_this)
{
	if($value != '-1' and trim($value) != '')
	{
        ...
        $min = (isset($vars['sf_min_'.$table_column]) and $vars['sf_min_'.$table_column] != '-1') ? str_replace(',', '', $vars['sf_min_'.$table_column]) : 0;
		$max = (isset($vars['sf_max_'.$table_column.'_max']) and $vars['sf_max_'.$table_column.'_max'] != '-1') ? str_replace(',', '', $vars['sf_max_'.$table_column.'_max']) : 0;
